...
namespace Age_Of_Nothing.UI
{
    ...
    public partial class SpriteUi : UserControl
    {
        ...
        private static readonly IReadOnlyDictionary<(Type, bool), Brush> _brushes = new Dictionary<(Type, bool), Brush>
        {
            ...
            { (typeof(Monastery), false), GetImageFill(Brushes.Yellow, "monastery") },
            { (typeof(Monastery), true), GetImageFill(Brushes.YellowGreen, "monastery") },
            ...
            { (typeof(Monk), false), GetImageFill(Brushes.Blue, "monk") },
            { (typeof(Monk), true), GetImageFill(Brushes.MediumSlateBlue, "monk") },
        ...
        {
            var p = Sprite.Surface.TopLeft.MoveFromOffset(_parent.Middle, _parent.Offset);
            SetValue(Canvas.LeftProperty, p.X - (Sprite.Focused ? StrokeAndSpace : 0));
            SetValue(Canvas.TopProperty, p.Y - (Sprite.Focused ? StrokeAndSpace : 0));
        }
